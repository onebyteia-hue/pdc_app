...
function initToggleAdaptaciones() {
  ...
  const previewTableBlock = document.getElementById(
    "preview-adaptaciones-significativas",
  );
  ...
  const apply = () => {
    ...
    if (previewTableBlock) {
      previewTableBlock.style.display = on ? "block" : "none";
    }
